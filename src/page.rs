...
impl Page {
    // ==========================================================================
    // DEPRECATED: enable_stealth_mode() has been removed.
    // Use ChaserPage::apply_profile() instead for complete stealth:
    //
    //   let profile = ChaserProfile::windows().build();
    //   let chaser = ChaserPage::new(page);
    //   chaser.apply_profile(&profile).await?;
    //
    // apply_profile() sets viewport, DPR, User-Agent, and injects all stealth
    // patches including Chrome mocks (runtime, csi, loadTimes, app, webstore).
    // ==========================================================================
